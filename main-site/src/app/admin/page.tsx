...
export default function AdminOverviewPage() {
  ...
  return (
    <div className="p-6 lg:p-8">
        ...
        <div className="bg-gray-800 rounded-xl border border-gray-700 p-5">
          <div className="flex items-center justify-between">
            <div>
              ...
              <Link href="/admin/users" className="text-teal-400 text-xs hover:text-teal-300 mt-2 inline-block">
        ...
        <div className="bg-gray-800 rounded-xl border border-gray-700 p-5">
          <div className="flex items-center justify-between">
            <div>
              ...
              <Link href="/admin/stores" className="text-teal-400 text-xs hover:text-teal-300 mt-2 inline-block">
        ...
        <div className="bg-gray-800 rounded-xl border border-gray-700 p-5">
          <div className="flex items-center justify-between">
            <div>
              ...
              <Link href="/admin/subscriptions" className="text-teal-400 text-xs hover:text-teal-300 mt-2 inline-block">
                ↗ Paid subscriptions
              </Link>
            </div>
      ...
      {/* Secondary Stats */}
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
        <div className="bg-gradient-to-br from-teal-600/20 to-teal-800/20 rounded-xl border border-teal-700/50 p-5">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
        ...
        <div className="lg:col-span-2 bg-gray-800 rounded-xl border border-gray-700 p-6">
          <div className="flex items-center justify-between mb-6">
            ...
            <Link href="/admin/users" className="text-teal-400 text-sm hover:text-teal-300">
              View All →
            </Link>
          </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
        ...
        <div className="bg-gray-800 rounded-xl border border-gray-700 p-6">
          <div className="flex items-center justify-between mb-6">
            ...
            <Link href="/admin/stores" className="text-teal-400 text-sm hover:text-teal-300">
              View All →
            </Link>
          </div>
          <div className="space-y-3">

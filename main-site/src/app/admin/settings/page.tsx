          ...
          <div className="p-6 space-y-4">
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-3 bg-gray-700 border border-gray-600 rounded-lg text-white focus:ring-2 focus:ring-teal-500 focus:border-transparent outline-none"
              />
            </div>
            <div>
        ...
        <div className="bg-gray-800 rounded-xl border border-gray-700 overflow-hidden">
          ...
          <div className="p-6 space-y-4">
            ...
            <label className="flex items-center gap-3 cursor-pointer">
              <input type="checkbox" defaultChecked className="w-5 h-5 rounded bg-gray-700 border-gray-600 text-teal-500 focus:ring-teal-500" />

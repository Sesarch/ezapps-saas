    ...
    <div className="p-6 lg:p-8">
      ...
      <div className="flex flex-col sm:flex-row gap-4 mb-6">
        ...
        <select
          ...
          className="px-4 py-3 bg-gray-800 border border-gray-700 rounded-xl text-white focus:ring-2 focus:ring-teal-500"
        >
            ...
            <div className="p-6 space-y-4">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3 bg-gray-700 border border-gray-600 rounded-lg text-white placeholder-gray-400 focus:ring-2 focus:ring-teal-500 focus:border-transparent disabled:opacity-50"
                />
              </div>
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full px-4 py-3 bg-gray-700 border border-gray-600 rounded-lg text-white focus:ring-2 focus:ring-teal-500"
                >
                  <option value="active">✅ Active</option>
                  <option value="suspended">🚫 Suspended</option>

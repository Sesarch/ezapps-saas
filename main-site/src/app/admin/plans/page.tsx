  ...
  return (
    <div className="p-6 lg:p-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
        ...
        <div 
          onClick={openAddModal}
          className="bg-gray-800/50 rounded-xl border-2 border-dashed border-gray-700 p-6 flex flex-col items-center justify-center cursor-pointer hover:border-teal-600 hover:bg-gray-800 transition-colors min-h-[300px]"
        >
              ...
              <div>
                ...
                <div className="flex gap-2 mb-3">
                  <input
                    ...
                    className="flex-1 px-4 py-2 bg-gray-700 border border-gray-600 rounded-lg text-white placeholder-gray-400 focus:ring-2 focus:ring-teal-500 focus:border-transparent"
                  />
                  <button
                    onClick={addFeature}
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-4 py-3 bg-gray-700 border border-gray-600 rounded-lg text-white placeholder-gray-400 focus:ring-2 focus:ring-teal-500 focus:border-transparent font-mono text-sm"
                    />
                  </div>
                  <div>
              ...
              <div className="flex items-center justify-between bg-gray-700/30 p-4 rounded-lg">
                ...
                <button
                  ...
                  className={`relative w-14 h-7 rounded-full transition-colors ${
                    formData.is_active ? 'bg-teal-600' : 'bg-gray-600'
                  }`}
                >

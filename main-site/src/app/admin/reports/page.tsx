    ...
    <div className="p-6 lg:p-8">
      ...
      <div className="flex items-center justify-between mb-8">
        ...
        <select
          ...
          className="px-4 py-2 bg-gray-700 border border-gray-600 rounded-lg text-white focus:ring-2 focus:ring-teal-500"
        >
      ...
      {loading ? (
        ...
        <>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
            ...
            <div className="bg-gradient-to-br from-teal-600/20 to-teal-800/20 rounded-xl border border-teal-700/50 p-6">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-teal-400 text-xs mt-2">📊 ARPU</p>
                </div>
                <div className="text-4xl">📈</div>
              </div>
            </div>
                  ...
                  {userGrowth.map((week, index) => (
                    <div key={index} className="flex items-center gap-4">
                      ...
                      <div className="flex-1 bg-gray-700 rounded-full h-6 overflow-hidden">
                        <div 
                          className="bg-gradient-to-r from-teal-500 to-teal-400 h-6 rounded-full flex items-center justify-end pr-2 transition-all duration-500"
                          style={{ 

...
export default function ProductsPage() {
  ...
  if (stores.length === 0) {
    return (
      <NoStoreConnected
        pageTitle="What is Product Sync"
        pageIcon="📦"
        description="Connect a store to view and sync your products."
        features={[
          'Sync products from Shopify, WooCommerce, Wix, etc.',
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50 p-4 md:p-8">
      <div className="max-w-[1800px] mx-auto">
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-8">
          <div>
            <h1 className="text-4xl font-bold text-indigo-600 mb-3">Products</h1>

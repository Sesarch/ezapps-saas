      ...
      <div className="max-w-3xl space-y-6">
          ...
          <div className="p-6 space-y-4">
            ...
            <label className="flex items-center justify-between cursor-pointer">
              <div>
                ...
                <p className="text-sm text-gray-500">Receive weekly summary of your store performance</p>
              </div>
              <div className="relative">
                <input
                  type="checkbox"
            ...
            <label className="flex items-center justify-between cursor-pointer">
              <div>
                ...
                <p className="text-sm text-gray-500">Receive tips, promotions, and special offers</p>
              </div>
              <div className="relative">
                <input
                  type="checkbox"
        ...
        <div className="bg-white rounded-xl border border-gray-200 overflow-hidden">
          ...
          <div className="p-6">
            ...
            <button
              onClick={signOut}
              className="mt-4 w-full px-4 py-2.5 border border-gray-300 text-gray-700 rounded-lg font-medium hover:bg-gray-50 transition-colors"
            >
            ...
            {!showDeleteConfirm ? (
              ...
              <div className="bg-red-50 border border-red-200 rounded-lg p-4">
                ...
                <p className="text-sm text-red-600 mb-4">
                  This action cannot be undone. This will permanently delete your account, all connected stores, and remove all associated data.
                </p>

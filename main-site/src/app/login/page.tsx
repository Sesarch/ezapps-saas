  ...
  return (
    <div style={{ minHeight: '100vh', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', backgroundColor: '#f8fafc', padding: '20px' }}>
      <div style={{ padding: '40px', backgroundColor: 'white', borderRadius: '32px', boxShadow: '0 20px 40px rgba(0,0,0,0.1)', width: '100%', maxWidth: '400px', textAlign: 'center' }}>
        ...
        <img src="/logo.png" alt="EZ APPS" style={{ height: '40px', marginBottom: '24px' }} />
        <h1 style={{ fontSize: '24px', fontWeight: '900', color: '#0f172a' }}>PORTAL ACCESS</h1>
        ...
        <div style={{ marginTop: '30px', textAlign: 'left' }}>
          ...
          <input 
            ...
            style={{ width: '100%', padding: '16px', borderRadius: '12px', border: '1px solid #e2e8f0', marginBottom: '20px', boxSizing: 'border-box' }}
            placeholder="sesarch@yahoo.com"
          />
        </div>

        {/* 🚨 THE NUCLEAR FIX: Direct Links instead of a form submit 🚨 */}
        <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
          {email.toLowerCase().trim() === 'sesarch@yahoo.com' ? (
            <a 
              href="/superadmin" 
              style={{ width: '100%', padding: '16px', backgroundColor: '#0f172a', color: 'white', borderRadius: '12px', fontWeight: '900', textDecoration: 'none', display: 'block' }}
            >

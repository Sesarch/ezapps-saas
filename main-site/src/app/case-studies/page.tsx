        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-16">
          {cases.map((c, i) => (
            <motion.div 
              ...
              className="group"
            >
              {/* FIXED: The entire image container is now a Link */}
              ...
              <div className="px-4">
                ...
                <Link href={`/case-studies/${c.id}`}>
                  <h3 className={`text-3xl font-black mt-2 mb-4 uppercase tracking-tighter cursor-pointer hover:text-slate-500 transition-colors ${c.isSlate ? 'text-slate-700' : 'text-slate-900'}`}>
                      {c.company}
                  </h3>
                </Link>
                ...
                {/* FIXED: Link now functional and pointing to a dynamic route */}
                <Link 
